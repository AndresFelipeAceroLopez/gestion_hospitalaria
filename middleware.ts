...
export async function middleware(request: NextRequest) {
  ...
  // PASO CRITICO: Refrescar la sesión en cada request.
  // Sin esto, la sesión expira y el usuario es desconectado.
  const {
    data: { session },
  ...
  // Si hay sesión y el usuario intenta ir al login -> redirigir al dashboard
