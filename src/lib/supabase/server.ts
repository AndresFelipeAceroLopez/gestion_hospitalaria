 ...
 *
 * @pattern Factory Pattern — centraliza la creación del cliente
 * @principle SRP — este archivo tiene una sola responsabilidad: crear
 * el cliente Supabase del lado del servidor
 *
 * IMPORTANTE: Esta función es ASYNC porque necesita acceder a las
 ...
 * Incluye el manejo automático de cookies para sesiones.
 *
  ...
  return createServerClient<Database>(
    ...
    process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY!,
    {
      cookies: {
        ...
        // Actualiza las cookies en la response (para refrescar sesión)
        setAll(cookiesToSet) {
          try {
