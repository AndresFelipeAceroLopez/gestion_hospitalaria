/**
 * @file src/modules/especialidades/especialidadservice.ts
 */
...
export class EspecialidadService {
    constructor(
        private readonly repo: IRepository<Especialidad, number, CreateEspecialidadDTO>
    ) { }
    ...
    async getById(id: number): Promise<ServiceResult<Especialidad>> {
        try {
    ...
    async update(id: number, updates: Partial<CreateEspecialidadDTO>): Promise<ServiceResult<Especialidad>> {
        try {
    ...
    private handleError(err: unknown): string {
        ...
        return "Error en EspecialidadService";
    }
}
