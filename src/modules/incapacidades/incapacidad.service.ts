/**
 * @file src/modules/incapacidades/incapacidadservice.ts
 */
...
export class IncapacidadService {
    constructor(
        private readonly repo: IRepository<IncapacidadConRelaciones, number, any>
    ) { }

    async getAll(): Promise<ServiceResult<IncapacidadConRelaciones[]>> {
        try {
    ...
    async getById(id: number): Promise<ServiceResult<IncapacidadConRelaciones>> {
        try {
    ...
    async create(dto: any): Promise<ServiceResult<IncapacidadConRelaciones>> {
        try {
    ...
    async update(id: number, updates: any): Promise<ServiceResult<IncapacidadConRelaciones>> {
        try {
    ...
    private handleError(err: unknown): string {
        ...
        return "Error en IncapacidadService";
    }
}
