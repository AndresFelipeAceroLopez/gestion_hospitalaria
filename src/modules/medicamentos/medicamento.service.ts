/**
 * @file src/modules/medicamentos/medicamentoservice.ts
 */
...
export class MedicamentoService {
    constructor(
        private readonly repo: IRepository<Medicamento, number, any>
    ) { }
    ...
    async getById(id: number): Promise<ServiceResult<Medicamento>> {
        try {
    ...
    async create(dto: any): Promise<ServiceResult<Medicamento>> {
        try {
    ...
    async update(id: number, updates: any): Promise<ServiceResult<Medicamento>> {
        try {
    ...
    private handleError(err: unknown): string {
        ...
        return "Error en MedicamentoService";
    }
}
